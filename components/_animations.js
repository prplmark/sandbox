export var animate = {
	...
	header: function(){
		...
		// Dispatch "more info" area
		document.dispatchEvent(new CustomEvent('paper_loaded'));
		...
		TweenMax.staggerFromTo(headerElements, 1.2, {y: 128, scale: 0.95}, {y: 0, scale: 1}, 0.15);
